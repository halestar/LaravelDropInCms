...
[
    ...
    "delete.confirm" => 'Are you sure you wish to delete this css sheet?',
    "name" => "Css Sheet Name",
    "name.help" => "The name of the css sheet. Required",
    "description" => "Css Sheet Description",
    "description.help" => "Optional description of what this sheet does.",
