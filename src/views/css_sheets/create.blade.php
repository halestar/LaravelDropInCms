...
@section('content')
    <div class="container">
        <h1 class="border-bottom d-flex justify-content-between align-items-center">
            {{__('dicms::css_sheets.new')}}
        </h1>
        <form method="POST" action="{{ \halestar\LaravelDropInCms\DiCMS::dicmsRoute('admin.sites.sheets.store', ['site' => $site->id]) }}"  enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
