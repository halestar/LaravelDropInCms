...
@section('index_content')
    <form method="POST" action="{{ \halestar\LaravelDropInCms\DiCMS::dicmsRoute('admin.sheets.store') }}"  enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="row">
            ...
            <a class="btn btn-secondary col m-2" href="{{ \halestar\LaravelDropInCms\DiCMS::dicmsRoute('admin.sheets.index') }}">{{ __('dicms::admin.cancel') }}</a>
        </div>
    </form>
@endsection
