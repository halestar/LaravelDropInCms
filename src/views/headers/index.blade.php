...
@section('index_content')
    @if(\halestar\LaravelDropInCms\Models\Header::count() > 0)
    <div class="ms-1 row">
            ...
            <li class="list-group-item list-group-item-action">
                <div class="row align-items-center">
                    ...
                    <div class="col-2 text-end">
                        ...
                        <a
                            role="button"
                            href="{{ \halestar\LaravelDropInCms\DiCMS::dicmsRoute('admin.headers.edit', ['header' => $header->id]) }}"
                        ...
                        @can('create', \halestar\LaravelDropInCms\Models\Header::class)
                            <a
                                href="{{ \halestar\LaravelDropInCms\DiCMS::dicmsRoute('admin.headers.duplicate', ['header' => $header->id]) }}"
                                role="button"
                                class="btn btn-warning btn-sm ms-2"
                                title="{{ __('dicms::headers.duplicate') }}"
                            ><i class="fa-solid fa-clone"></i></a>
                        @endcan
                        @can('delete', \halestar\LaravelDropInCms\Models\Header::class)
                        <button
                            type="button"
                            onclick="confirmDelete('{{ __('dicms::headers.delete.confirm') }}', '{{ \halestar\LaravelDropInCms\DiCMS::dicmsRoute('admin.headers.destroy', ['header' => $header->id]) }}')"
