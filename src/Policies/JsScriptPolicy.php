...
class JsScriptPolicy
{
     ...
     */
    public function view($user = null, JsScript $script = null): bool
    {
        return true;
    }
     ...
     */
    public function update($user = null, JsScript $script = null): bool
    {
        return true;
    }
     ...
     */
    public function delete($user = null, JsScript $script = null): bool
    {
        return true;
    }
}
